...
namespace LittlePeeps.Tests
{
    ...
    public class HarvestTrackingTests
    {
        ...
        {
            resourceSystem.AddHarvest(Harvested, Worker, 3f);
        ...
        {
            resourceSystem.AddHarvest(Harvested, Worker, 3f);
            resourceSystem.AddHarvest(Harvested, Worker, 4f);
            resourceSystem.AddHarvest(ResourceType.Wood, Worker, 5f);
        ...
        public void Initialize_BindsTheNewRunsLedger_AndLeavesTheFinishedOneAlone()
        {
            ...
            run = new RunContext();
            resourceSystem.Initialize(run);
            resourceSystem.AddHarvest(Harvested, Worker, 2f);
