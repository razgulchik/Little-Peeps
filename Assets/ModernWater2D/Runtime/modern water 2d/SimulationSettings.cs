...
namespace Water2D
{
    ...
    public class SimulationSettings
    {
        ...
        public WaterCryo<int> chunksX = new WaterCryo<int>(1);
        public WaterCryo<int> chunksY = new WaterCryo<int>(1);
        public WaterCryo<float> waveRad = new WaterCryo<float>(1f);
        ...
        public WaterCryo<bool> moreStableObstructionSimulation = new WaterCryo<bool>(false);
        ...
        internal void onValueChanged(UnityAction onOSimulationChanged)
        {
            ...
            moreStableObstructionSimulation.onValueChanged = onOSimulationChanged;
